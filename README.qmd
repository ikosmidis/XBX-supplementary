...
`7.` [`code/xbx-vs-cn-beta.R`](code/xbx-vs-beta-crps.R) and [`code/xbx-vs-cn-ols.R`](code/xbx-vs-ols-crps.R) carry out the numerical experiments in Section S5 of the supplementary material document, and reproduce
